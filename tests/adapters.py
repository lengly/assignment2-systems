...
from cs336_systems.flashattention import CustomFlashAttentPytorch, CustomFlashAttentTriton
from cs336_systems.ddp_benchmark import NaiveDDP
...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    return CustomFlashAttentPytorch
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    return CustomFlashAttentTriton
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    return NaiveDDP(module, ddp_type='overlap_individual')
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    return NaiveDDP(module, bucket_size_mb, ddp_type='overlap_bucketed')
